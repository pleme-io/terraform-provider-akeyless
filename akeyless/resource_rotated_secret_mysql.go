...
func resourceRotatedSecretMySql() *schema.Resource {
	return &schema.Resource{
		Description: "Mysql rotated secret resource",
		Create:      resourceRotatedSecretMySqlCreate,
		Read:        resourceRotatedSecretMySqlRead,
		Update:      resourceRotatedSecretMySqlUpdate,
		Delete:      resourceRotatedSecretMySqlDelete,
		Importer: &schema.ResourceImporter{
			State: resourceRotatedSecretMySqlImport,
		},
...
func resourceRotatedSecretMySqlDelete(d *schema.ResourceData, m interface{}) error {
