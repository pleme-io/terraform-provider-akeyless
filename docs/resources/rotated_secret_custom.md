...
- `secure_access_web_browsing` (Boolean) Secure browser via Akeyless Secure Remote Access
- `secure_access_web_proxy` (Boolean) Web-Proxy via Akeyless Secure Remote Access
