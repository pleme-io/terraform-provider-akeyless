...
page_title: "akeyless_rotated_secret_ssh Resource - terraform-provider-akeyless"
subcategory: ""
description: |-
  Ssh rotated secret resource
---

# akeyless_rotated_secret_ssh (Resource)
...
- `rotator_custom_cmd` (String) Custom rotation command
